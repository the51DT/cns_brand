        ...
        rollupOptions: {
            ...
            output: {
                ...
                assetFileNames: (assetInfo) => {
                    ...
                    if (/\.(mp4|webm|mov)$/i.test(assetInfo.name)) {
                        if (assetInfo.name.includes('src/assets/image/main/')) {
                            return 'src/assets/image/main/[name][extname]';
                        }
                        return 'assets/images/[name][extname]'; // 영상
                    }
